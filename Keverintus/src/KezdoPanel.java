...
public class KezdoPanel implements ActionListener {
	...
	KezdoPanel(){
		...
		//cb (checkBox)
		JLabel l4=new JLabel("Egyedül szeretném meaning a labirintust.");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource()==keszGomb)
		{
			...
			//ha nem adott meg a felhasznalo fajlnevet amibol betoltse a jatekot
			if (!fNev.equals(""))
			{
				try {
